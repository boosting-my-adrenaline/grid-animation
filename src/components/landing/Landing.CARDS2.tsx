...
import { LandingCardSquareSmall } from './Landing.card.square.small'
import { LandingCardSquareSmall2 } from './Landing.card.square.small2'

interface IProps {
  sm: boolean
  handleNavigate: () => void
}
export const LandingCARDS2: React.FC<IProps> = ({ sm, handleNavigate }) => {
      ...
      >
        ...
        <ul
          ...
          style={{
            ...
            gap: !sm ? 20 : 10,
            gridTemplateColumns: `repeat(14, ${columnWidth}px) `,
            // columnGap: 20,
