...
const h0 = require('../../static/neon/n0.jpg')
const h1 = require('../../static/neon/n1.jpg')
const h2 = require('../../static/neon/n2.jpg')
const h3 = require('../../static/neon/n3.jpg')
const h4 = require('../../static/neon/n4.jpg')
...
export const LandingCardRectSmall2: React.FC<IProps> = ({ sm, option }) => {
  const { isDarkMode } = useDarkMode()

  const images = [h0, h1, h2, h3, h4]
  ...
  return (
    <div className={`full h-full cursor-pointer select-none`}>
      ...
      <div className={`font-UI `}>
        <div>
          <span
            className={` text-[12px] font-[400] capitalize 
